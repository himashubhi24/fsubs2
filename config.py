...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7349996082:AAHrY_-ymo6CyJRCA2DURUVaWqrr0dfwriE")
...
#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002131322645"))
...
SHORTLINK_API = os.environ.get("SHORTLINK_API", "68a3194f9bbd73656ff36704ad4091ed4292fc54")
...
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1002241306535"))
...
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS", "5297358633 5787502520 6973006557").split()):
        ADMINS.append(int(x))
except ValueError:
